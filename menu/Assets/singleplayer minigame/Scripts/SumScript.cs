...
public class SumScript : MonoBehaviour
{
    ...
    static void UpdateQuestion()
    {
        ...
        if (fragenCounter == 4)
        {
            ...
            HighscoreApple.Start();
            HighscoreApple.InsertScore((HighscoreApple.GetLastID() + 1).ToString(), 0, theDate.ToString(),rightCounter,3-rightCounter,2,2);
    ...
    public static void UpdateScore()
    {
        ...
        if (score == (PR1 + PR2)&& PlayerMovementApple.check==true)
        {
            score = 0;
            counter = 0;
            PlayerMovementApple.check = false;
